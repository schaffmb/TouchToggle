...
EXPB-PowerBooster is an open source project for open source projects. Those wishing to
create closed projects should seek an alternate solution.
EXPB-PowerBooster is licensed under the terms of the GNU General Public License v3.0
...
For full details on the licensing of EXPB-PowerBooster and its components, see the included licensing file.
